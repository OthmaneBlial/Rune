...
The shell discovery test also verifies `type` for aliases, Rust built-ins, and
missing names, keeping host executable discovery out of the portable boundary.
